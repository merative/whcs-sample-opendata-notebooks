...
The [**iml-covid-19-sample**](https://github.com/IBM/whcs-sample-opendata-notebooks/tree/master/iml-covid-19-sample) notebook demonstrates how to use **IBM Watson Insights for Medical Literature** to interface with an enriched covid-19 corpus. Various experiments are provided showing different methods for understanding and querying the corpus.  The various experiments have supporting documentation in the notebook.
